...
```{r include = FALSE}
source("script/Chart_Covid-19 cases mortality rates for every sex in each age group.R")
```

Chart_3_Covid-19 cases mortality rates for every sex in each age group
Based on the chart, we could see that 
